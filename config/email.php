...
define('EMAIL_PROVIDER', 'gmail_smtp');  // Options: 'gmail_smtp', 'local_test'

// Gmail/SMTP Configuration
// For Gmail: Use App Passwords (https://myaccount.google.com/apppasswords)
define('EMAIL_DEBUG_MODE', false);  // Set to true for testing without sending actual emails

define('GMAIL_ADDRESS', 'gumabaojohnmanuel1506@gmail.com');
define('GMAIL_APP_PASSWORD', 'hovd irvh yyza dbea');  // 16-char App Password
define('SMTP_HOST', 'smtp.gmail.com');
define('SMTP_PORT', 587);
define('SMTP_ENCRYPTION', 'tls');  // 'tls' or 'ssl'

// Email sender name
define('EMAIL_FROM_NAME', 'UGAT Notifications');
define('EMAIL_FROM_ADDRESS', 'gumabaojohnmanuel1506@gmail.com');
